...
const CLIENT_ID = '747195cefbda4106802ec32d1361f958';
const CLIENT_SECRET = '92c95ba10bba40d2895dea9fd3729149';
...
export const toggleLike = createAsyncThunk(
    ...
    async(song, { getState }) => {
        ...
        const updatedLikedSongs = isLiked ?
            likedSongs.filter(s => s.id !== song.id) : [...likedSongs, song];
...
export const playTrack = createAsyncThunk(
    ...
    async(track, { dispatch, getState }) => {
        ...
        try {
            await axios.put(
                `https://api.spotify.com/v1/me/player/play`, { uris: [track.uri] }, {
                    headers: {
                        'Authorization': `Bearer ${accessToken}`,
